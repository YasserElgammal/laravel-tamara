...
final class OrderService
{
    ...
    /** @return array<string,mixed> */ public function get(string $orderId): array { return $this->client->get('/orders/'.$orderId); }
    /** @return array<string,mixed> */ public function authorise(string $orderId): array { return $this->client->post('/orders/'.$orderId.'/authorise'); }
    /** @return array<string,mixed> */ public function paymentTypes(string $country,float $value,string $currency='SAR',?string $phone=null): array { return $this->client->get('/checkout/payment-types',array_filter(['country'=>$country,'currency'=>$currency,'order_value'=>$value,'phone'=>$phone],fn($v)=>$v!==null&&$v!=='')); }
}
