...
final class WebhookHandler
{
    ...
    public function handle(WebhookData $data): bool
    {
        ...
        $class = match ($data->type) {
            WebhookEventType::APPROVED => TamaraOrderApproved::class,
            WebhookEventType::DECLINED => TamaraOrderDeclined::class,
            WebhookEventType::AUTHORISED => TamaraOrderAuthorised::class,
            WebhookEventType::CANCELED => TamaraOrderCanceled::class,
            WebhookEventType::CAPTURED => TamaraPaymentCaptured::class,
            WebhookEventType::REFUNDED => TamaraRefundCreated::class,
            WebhookEventType::EXPIRED => TamaraOrderExpired::class
        };
